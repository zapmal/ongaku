...
import { Background, HeaderContainer } from '../../misc/styles';
        ...
        <div>
          ...
          <Box textAlign="center">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <Button type="submit" align="center" variant="accent" props={{ marginTop: '40px' }}>
                Submit
              </Button>
              <Text color={theme.colors.primaryText.value} padding="1">
                or
              </Text>
              ...
              <Center paddingTop="30px" paddingBottom="2">
                <Text color={theme.colors.primaryText.value} maxW="500px">
                  By using our application you agree to the usage of cookies, which are needed to
                  make the application work correctly. We also store your IP address and
                  registration date for security purposes.
                </Text>
              </Center>
            </form>
          </Box>
